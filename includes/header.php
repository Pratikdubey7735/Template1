...
?>
    ...
    <h1 class="m-0"><img src="admin/uploads/<?php echo $SITESETTING['logo'];?>" style="width: 40%;"></h1>
    </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <!-- <a href="contact.php" class="btn btn-primary py-4 px-lg-4 rounded-0 d-none d-lg-block">Contact<i class="fa fa-arrow-right ms-3"></i></a> -->
        </div>
    </nav>
    <!-- Navbar End -->